...
function finelineglobal_technology_portfolio_custom_post_type() {

    $single = 'Technology Portfolio Item';
    $plural = 'Technology Portfolio';
	...
	register_post_type( 'technology-portfolio', $args );

}
add_action( 'init', 'finelineglobal_technology_portfolio_custom_post_type', 0 );
